  ...
  return (
    ...
    >
      <div className="container-custom">
        ...
        <div className="mb-16">
          <Card
            className="testimonial-card max-w-5xl mx-auto border-2 border-orange-500/20 bg-gradient-to-br from-white to-slate-50"
            hover3d={true}
            glowEffect={true}
          >
            <div className="flex items-start gap-6 mb-6">
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center text-white text-3xl font-bold flex-shrink-0">
                DT
              </div>
              <div className="flex-1">
                ...
                <p className="text-lg text-slate-600 mb-1">Construction Manager</p>
          ...
          {testimonials.slice(1).map((testimonial) => (
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-6">
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center text-white text-xl font-bold flex-shrink-0">
